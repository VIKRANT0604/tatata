...
from GAYU.misc import _boot_
from GAYU.plugins.sudo.sudoers import sudoers_list
...
from GAYU.utils.decorators.language import LanguageStart
from GAYU.utils.formatters import get_readable_time
from GAYU.utils.inline import help_pannel, private_panel, start_panel
...
async def start_pm(client, message: Message, _):
    ...
    # Typing effect part
    typing_message = await message.reply("<b>⚜️𝐌 𝐢 𝐭 𝐰 𝐚⚜️</b>")  # Initial message
    
    # Simulate typing
    typing_text = "<b>Starting...🥀</b>"
