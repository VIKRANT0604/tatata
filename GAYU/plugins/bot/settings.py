...
from GAYU.utils.decorators.admins import ActualAdminCB
from GAYU.utils.decorators.language import language, languageCB
from GAYU.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from GAYU.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://files.catbox.moe/5z95gd.mp4"),
