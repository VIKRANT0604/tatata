...
#BOT FILE NAME
from GAYU import app as app
from GAYU.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="🦚𝐑𝐚𝐝𝐡𝐞🦚 🦚𝐑𝐚𝐝𝐡𝐞🦚",
            url=f"https://t.me/FRIENDS_ZONE_CHATTING_GROUP",
        ),
    ],
]
...
async def ctest(_, message):
    ...
    try:
     ...
     #  if not is_selected:
         ...
         img = Image.open("GAYU/assets/cppic.png")
